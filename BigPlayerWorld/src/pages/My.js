    ...
    >
      <div className="my_main">
        ...
        >
          ...
          >
            ...
            >
              {props.darkTheme ? (
                <span>
                  <i class="fas fa-sun" style={{ fontSize: "20px" }}></i>
                </span>
              ) : (
                <span>
                  <i class="fas fa-moon" style={{ fontSize: "20px" }}></i>
                </span>
              )}
            </button> */}
          </div>
          <div className="usercard_down">
            <button
              ...
              //         ? "1px solid #644fd1"
              //         : "1px solid #343536",
              //     color: props.mode === "light" ? "#6655d3" : "white",
              //   }}
              style={{
        ...
        <div
          ...
          //   style={{
          //     color: props.mode === "light" ? "#413f3f" : "white",
          //     marginTop: "10px",
          //   }}
        ...
        >
          ...
          >
            <div className="my_main_option_left">
              {/* <img
                className="my_main_option_left_img"
          ...
          <Link to={"/withdraw"} className="my_main_option">
            <div className="my_main_option_left">
              ...
              {/* <img
                className="my_main_option_left_img"
                src="https://cdn-icons-png.flaticon.com/512/7939/7939988.png"
                alt=""
              /> */}
              <p style={{ fontWeight: props.darkTheme ? "normal" : "bold" }}>
                Withdrawal
          ...
          <Link onClick={toggleMenu}>
            <div className="my_main_option">
              <div className="my_main_option_left">
                {/* <img
                className="my_main_option_left_img"
                src="https://www.fastwin.app/includes/icons/fdetail.png"
                alt=""
              /> */}
                <i
          ...
          <Link
            ...
            // style={{
            //   backgroundColor:
            //     props.mode === "light" ? "rgba(51, 51, 51, 0.05)" : "black",
